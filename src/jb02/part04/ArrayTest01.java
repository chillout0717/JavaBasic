...
/*
 		...
 		2. Reference Data Type의 이해(참조형)
 		3. new / .keyword 사용
 		. -> 이름 부르는 것이라고 이해하면 쉬움 ex)홍길동. 밥먹어!
 */
...
public class ArrayTest01 {
	...
	public static void main(String[] args) {
		...
		//1. int Data Type array 산언 ==> int[] intArray; or int intArray[];
		...
		for(int k=0; k<intArray.length; k++) {
			System.out.println("5 x"+ intArray +" = "+5 * intArray[k]);
		}
		...
		j[5] = 1234;
		//j가 참조하는 방 안에 1234를 넣은 거니까, 그 방 (참조당한 방)_안에도 당연히 1234가 들어가겠지...?
