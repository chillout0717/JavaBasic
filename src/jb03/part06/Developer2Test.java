...
/*
 *  ==> Developer2.class 를 Instance 생성 사용하는 class정의 :: Application class 정의
 */
...
public class Developer2Test {
	...
	public static void main(String[] args) {
		...
		//정보가 public 일때는 이렇게 접근 할 수 있음
		//하지만 정보가 private일 땐 이렇게 접근 불가!
		...
		//정보가 private 일떈 get메소드로 접근해야 한다.
		//or get메소드 안에서 뭔가 if문을 줘서 이럴때, 값 리턴! 을 사용하고 싶을떄나
		//그러므로 get메소드가 캡슐화가 되어있다는 것을 알 수 있음!
