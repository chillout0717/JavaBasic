...
public class Developer2 {
	...
	String job = "개발자";
	int avgIncome = 100;
	int projectCareer; // <== Field 선어만 한 경우 (변수를 선언만 한 경우) 초기화 유무는?
	...
	public void instruct(int lectureCount) {
		System.out.println(lectureCount +"개 가의를 통한 수입 증가");
	...
	//				return "안알려줌";
	//		}
	//	} 이렇게 사용하면 비밀번호가 맞을 떄만 이름을 알 수 있음!
	// 	  정보를 숨기고 있는게 맞음.
	...
	//Developer2Test.java의 메소드를 붙여 넣을 수 있음
	public static void main(String[] args) {
		
		
		//Developer2.class 를 Instance생성
		Developer2 developer = new Developer2();
		
		//developer 식병성을 갖는 Instance .연산자를 통해 사용
		//정보가 public 일 때는 이렇게 접근 할 수 있음
		...
		//그러므로 get 메소드가 캡슐화가 되어있따는 것을 알 수 있음!
