...
public class CastingTest {
	...
	public static void main(String[] args) {
		...
		byte b5 = (byte)(b1+b4); 		//b1 : 100, b4 : 120이라 220이 나옴, byte는 127까지만 저장 가능
										// 그러므로 쓰레기 값이 출력됨. byte에 220을 담을 수 없기 때문
		...
		double test01 = 100 + 0.5;	//int와 double이 같이 있으면 double쪽으로 형변환 되어 100.5
		System.out.println(test01);
		//==> compile error 발생(확인요망)
		//int test02 = 100 + 0.5;	// 0.5는 double 타입인데 int에 대입하려고 해서
		...
		//double d2 = (double) 201/2; // (double)201이 명시적 형변환이 되어서 실수를 정수로 나누니까 실수형.
